		...
		<div class="modal-content">
			<form method="POST" enctype="multipart/form-data">
				<div class="modal-header">						
					<h4 class="modal-title">SE CADASTRE OU FAÇA O LOGIN</h4>
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="logar">
					<input type="submit" class="btn btn-success" value="cadastre-se" name="botao" >
				</div>
