        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="book.html">Cadastre-se</a>
              </li>
            </ul>
        ...
        <div class="row mb-5">
          ...
          <div class="col-sm-4 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/varanda.png.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                   Varanda do açai
          ...
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/vaqueiro.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Açai do vaqueiro
        ...
        <div class="row">
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/fiquebem.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Açai fique bem
        ...
        <div class="owl-carousel client_owl-carousel">
          ...
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="images/vaqueiro.png" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
