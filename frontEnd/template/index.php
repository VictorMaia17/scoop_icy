              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <a href="cadastrarLoja.php">
                      <p>
                        <h4>
                          cadastre já a sua loja!!!
                        </h4>
                      </p>
                    </a>
                    <div class="btn-box">
        ...
        <?php foreach($lojas as $loja){ ?>
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="../../lojas_logo/<?=$loja['logo']?>" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    <?php echo($loja['nome'])?>
                  ...
                  <form action="lojas/paginaLoja.php" method="POST" id="<?=$loja['cod']?>">
                    <input type="hidden" name="cod" value="<?=$loja['cod']?>">
                    <input type="hidden" name="nome" value="<?=$loja['nome']?>">
                    <input type="hidden" name="cnpj" value="<?=$loja['cnpj']?>">
                    <input type="hidden" name="email" value="<?=$loja['email']?>">
                    <input type="hidden" name="senha" value="<?=$loja['senha']?>">
                    <input type="hidden" name="numero" value="<?=$loja['numero']?>">
                    <input type="hidden" name="rua" value="<?=$loja['rua']?>">
                    <input type="hidden" name="bairro" value="<?=$loja['bairro']?>">
                    <input type="hidden" name="cidade" value="<?=$loja['cidade']?>">
                    <input type="hidden" name="complemento" value="<?=$loja['complemento']?>">
                    <input type="hidden" name="login" value="<?=$loja['login']?>">
                    <input type="hidden" name="statusLoja" value="<?=$loja['status']?>">
                    <input type="hidden" name="logo" value="<?=$loja['logo']?>">
                    <input type="hidden" name="descricao" value="<?=$loja['descricao']?>">
                    <input type="hidden" name="dias" value="<?=$loja['dias']?>">
                    <input type="hidden" name="instagram" value="<?=$loja['instagram']?>">
                    <input type="hidden" name="facebook" value="<?=$loja['facebook']?>">
                    <input type="hidden" name="taxa_entrega" value="<?=$loja['taxa_entrega']?>">
                    <input type="hidden" name="telefone" value="<?=$loja['telefone']?>">
                </form>

                  <div class="options">
                    <a href="" onclick="chamarTestaSession(event, <?=$loja['cod']?>)">
                      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
                        <g>
                          <g>
                            <path d="M345.6,338.862c-29.184,0-53.248,23.552-53.248,53.248c0,29.184,23.552,53.248,53.248,53.248
        ...
        <div class="owl-carousel client_owl-carousel">
          ...
          <div class="item">
            <div class="box">
              ...
              <div class="row" >
                <div class="col">
                  <center><img src="images/vitor.png" style="border: solid  0.3em #FDCAE5 ; border-radius: 100px;  width: 125px; height: 125px; object-fit: contain; "></center>
                </div>
                <div class="col">
                  <center><img src="images/gabriel.png" style="border: solid  0.3em #FDCAE5 ; border-radius: 100px;  width: 125px; height: 125px; object-fit: contain;"></center>
                </div>
            </div>
            </div>
          </div>
        ...
        <div class="col-md-4 footer-col">
          <div class="footer_detail">
            ...
            <div class="footer_social">
              ...
              <a href="https://www.instagram.com/scoop__icy/?next=%2F">
