              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      <h4>
                      A energia natural do açaí em cada tigela!
                    </h4>
                    </p>
                    <div class="btn-box">
                    </div>
        ...
        <div class="row mb-5">
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/nossaacaideira (1).png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Nossa açaideira
          ...
          <div class="col-sm-4 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/varanda.png (1).png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                   Varanda do açai
          ...
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/mariapitanga (1).png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Maria Pitanga
        ...
        <div class="row">
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/fiquebem (1).png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Açai fique bem
                  ...
                  <p>
                    A qualidade e o sabor que transformam o seu dia!
                  </p>
                  <div class="options">
                    <a href="" onclick="chamarTestaSession(event)">
                      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
          ...
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/vaqueiro (1).png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Açai do vaqueiro
                  ...
                  <p>
                    Nós levamos a felicidade para você!
                  </p>
                  <div class="options">
                    <a href="" onclick="chamarTestaSession(event)">
                      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
          ...
          <div class="col-sm-4 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="images/queromais (1).png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                   Açai quero mais
